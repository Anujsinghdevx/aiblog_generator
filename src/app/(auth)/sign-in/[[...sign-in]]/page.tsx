...
import { CheckCheck, Sparkles, ShieldCheck, PenTool } from "lucide-react";
      ...
      <aside className="relative hidden lg:flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl px-10 py-16">
          ...
          <h1 className="mt-5 text-4xl font-semibold tracking-tight text-gray-900 dark:text-white">
            Create, optimize, and ship SEO‑ready posts faster.
          </h1>
          <p className="mt-3 text-gray-600 dark:text-gray-300">
            Sign in to access your editor, drafts, and analytics dashboard powered by AI.
          </p>
        ...
        <div className="w-full max-w-md">
          <div className="mb-6 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Sign in to continue to AI Blog</p>
            </div>
          </div>
